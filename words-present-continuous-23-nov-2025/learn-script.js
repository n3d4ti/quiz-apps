class PairingGame {
    constructor() {
        // Present Continuous vocabulary pairs
        this.wordPairs = [
            { english: "She's studying", hungarian: 'Tanul' },
            { english: "She's cleaning", hungarian: 'Takarít' },
            { english: "He's watching TV", hungarian: 'Tévét néz' },
            { english: "They're listening to music", hungarian: 'Zenét hallgatnak' },
            { english: "He's reading", hungarian: 'Olvas' }
        ];
