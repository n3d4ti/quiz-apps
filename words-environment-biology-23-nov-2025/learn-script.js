class PairingGame {
    constructor() {
        // Environment & Biology vocabulary pairs
        this.wordPairs = [
            { english: "shell", hungarian: 'Csigaház' },
            { english: "waste", hungarian: 'Salakanyag' },
            { english: "excrete", hungarian: 'Kiválaszt' },
            { english: "sensitivity", hungarian: 'Érzékenység' },
            { english: "environment", hungarian: 'Környezet' },
            { english: "sweat", hungarian: 'Izzad, izzadtság' }
        ];
