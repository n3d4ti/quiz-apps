class PairingGame {
    constructor() {
        // Toys vocabulary pairs
        this.wordPairs = [
            { hungarian: 'játékok', english: 'toys' },
            { hungarian: 'labda', english: 'ball' },
            { hungarian: 'baba', english: 'doll' },
            { hungarian: 'számítógépes játék', english: 'computer game' },
            { hungarian: 'szörnyeteg', english: 'monster' },
            { hungarian: 'robot', english: 'robot' },
            { hungarian: 'papír sárkány', english: 'kite' }
        ];
