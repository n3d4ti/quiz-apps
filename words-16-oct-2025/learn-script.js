class PairingGame {
    constructor() {
        // Clothing vocabulary pairs
        this.wordPairs = [
            { hungarian: 'kézitáska', english: 'handbag' },
            { hungarian: 'karóra', english: 'watch' },
            { hungarian: 'póló', english: 't-shirt' },
            { hungarian: 'farmer', english: 'jeans' },
            { hungarian: 'cipő', english: 'shoes' },
            { hungarian: 'kabát', english: 'coat' },
            { hungarian: 'kalap', english: 'hat' },
            { hungarian: 'szoknya', english: 'skirt' },
            { hungarian: 'öv', english: 'belt' }
        ];
