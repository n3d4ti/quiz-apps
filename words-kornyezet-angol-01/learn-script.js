class PairingGame {
    constructor() {
        // Environment vocabulary pairs
        this.wordPairs = [
            { hungarian: 'lazac', english: 'salmon' },
            { hungarian: 'ivik (ikrát rak)', english: 'lay eggs' },
            { hungarian: 'gondoskodik', english: 'look after' },
            { hungarian: 'több mint', english: 'more than' },
            { hungarian: 'ezer', english: 'one thousand' },
            { hungarian: 'mint a barna medve', english: 'like the brown bear' },
            { hungarian: 'fial (szül)', english: 'give birth' },
            { hungarian: 'medvebocs', english: 'cub' },
            { hungarian: 'természet', english: 'nature' }
        ];
